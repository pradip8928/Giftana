    ...
    <div className="container-fluid">
      ...
      <div className="row">
        <div className="col-md-2 row-sm">
          <Sidebar
            buttons={[
              { name: "General", icon: "src/assets/icons/general.svg" },
              {
                name: "Search engines (SEO)",
                icon: "src/assets/icons/search.svg",
              },
              { name: "Products", icon: "src/assets/icons/box.svg" },
              { name: "MegaMenu", icon: "src/assets/icons/menu-down.svg" },
              { name: "Content Slider", icon: "src/assets/icons/photos.svg" },
            ]}
          />
        </div>
